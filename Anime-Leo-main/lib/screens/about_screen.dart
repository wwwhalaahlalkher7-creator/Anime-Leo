        ...
        children: [
          ...
          Text(
            AppLanguage.instance.text(
              'التطبيق لاكتشاف الأنمي ومتابعته: تصفح كتالوجًا، احفظ المفضلة، وتابع سجل مشاهدتك. بيانات الأنمي (العناوين، الصور، التقييمات) تُجلب مباشرة من Jikan في نسخة Beta وليست مخزنة في D1 داخل التطبيق.',
