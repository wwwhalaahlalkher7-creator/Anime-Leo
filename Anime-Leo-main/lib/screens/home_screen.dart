      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasError) {
          return UiStateCard(
            ...
            message: 'السبب: ${snapshot.error}\n\nهذه نسخة Beta تشخيصية؛ احتفظ بهذه الرسالة لإصلاح مصدر المشكلة.',
                ...
                child: Padding(
                  ...
                  child: UiStateCard(
                    ...
                    message: AppLanguage.instance.text(
                      'السبب: ${snapshot.error}\n\nهذه نسخة Beta تشخيصية؛ احتفظ بالرسالة كاملة.',
                      'Reason: ${snapshot.error}\n\nThis is a diagnostic Beta; keep the full message.',
                    ),
              ...
              child: Padding(
                ...
                child: UiStateCard(
                  ...
                  message: language.text(
                    'السبب: $error\n\nهذه نسخة Beta تشخيصية؛ لا نحجب سبب الفشل.',
                    'Reason: $error\n\nThis is a diagnostic Beta; the failure reason is intentionally visible.',
                  ),
