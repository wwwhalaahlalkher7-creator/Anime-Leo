        ...
        return RefreshIndicator(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              SliverToBoxAdapter(child: _SectionTitle(AppLanguage.instance.text(titleAr, titleEn))),
              if (items.isEmpty)
                SliverToBoxAdapter(child: Padding(padding: const EdgeInsets.all(20), child: UiStateCard(icon: icon, title: AppLanguage.instance.text('لا توجد بيانات', 'No data'), message: AppLanguage.instance.text('لا توجد عناوين مانجا أو مانهوا متاحة من المصدر حاليًا.', 'No manga or manhwa titles are currently available from the provider.'), compact: true)))
              else
                SliverPadding(
                  padding: const EdgeInsets.fromLTRB(20, 0, 20, 30),
                  sliver: SliverGrid(
